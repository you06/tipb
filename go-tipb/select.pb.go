...
type DAGRequest struct {
	...
	// page_size is set when dag paging is enabled.
	PageSize         *uint64 `protobuf:"varint,19,opt,name=page_size,json=pageSize" json:"page_size,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *DAGRequest) GetPageSize() uint64 {
...
func (m *DAGRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PageSize != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.PageSize))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *DAGRequest) Size() (n int) {
	...
	if m.PageSize != nil {
		n += 2 + sovSelect(uint64(*m.PageSize))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
var fileDescriptorSelect = []byte{
	...
	,
}
